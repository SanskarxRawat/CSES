...
public class RoadPreparation {
    ...
    static class Solution {
        ...
        static int  size[];
        static int counter;
        //this question is based on krushal algorithm

        public void solve(int testNumber, FastInput in, FastOutput out) {
            int n=in.ri (),m=in.ri ();

            PriorityQueue<Edge> queue=new PriorityQueue<Edge> ((a,b)->Integer.compare (a.weights,b.weights));
            for (int i = 0; i <m; i++) {
            ...
            out.prtl (counter==1?ans:"IMPOSSIBLE");
