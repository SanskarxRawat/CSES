...
public class CreatingStrings {
    ...
    static class Solution {
        ...
        public void solve(int testNumber, FastInput in, FastOutput out) {
           s=new char[in.nextLine ().length ()];
           in.readArray (s);
           for(char o:s) count[o-'a']++;

           permuate ("");
           out.prtl (permutations.size ());
           for(String o:permutations) out.prtl (o);


        }
        static void permuate(String current){
