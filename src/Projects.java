...
public class Projects {
    ...
    static class Solution {
        ...
        public void solve(int testNumber, FastInput in, FastOutput out) {
            ...
            for (int i = 0; i <n; i++) {
                projects[i]=new Project (in.ri (),in.ri (),in.ri ());
            }
            ...
            long[] dp=new long[2_000_01];
            dp[0]=0;

            for (int i = 1; i <n+1; i++) {
                dp[i]=Math.max (dp[i-1],projects[i-1].getRewards ()+dp[LowerBound (projects[i-1].getStart (),projects)]);
            }
            out.prtl (dp[n]);
        ...
        static class Project{
            ...
            public Project(int start,int end,int rewards){
                this.start=start;
                this.end=end;
        ...
        static int LowerBound(int x,Project[] projects) { // x is the target value or key
            int l=-1,r=projects.length;
            while(l+1<r) {
                int m=(l+r)>>>1;
                if(projects[m].getEnd ()>=x) r=m;
                else l=m;
            }
            return r;
        }
